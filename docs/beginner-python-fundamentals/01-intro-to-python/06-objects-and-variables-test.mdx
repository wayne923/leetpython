...
import StreamlitEmbed from '@site/src/components/StreamlitEmbed';
...
Try out the concepts you're learning in our interactive Python playground:

<StreamlitEmbed 
  url="https://objects-and-variables.streamlit.app/"
  height={800}
  showToolbar={true}
/>
...
### Try It Yourself!
Experiment with different object types in our interactive console above. Try creating variables of different types and see how they behave!
...
Use the interactive playground above to:
1. Create variables of different types
2. See how variable unpacking works
3. Experiment with mutable and immutable objects
4. Try out dictionary operations
5. Write and execute your own Python code
